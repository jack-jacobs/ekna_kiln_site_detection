...
inputpath = f"{os.environ['HOME']}/ekna_kiln_detect/inputs/{sys.argv[1]}/list_tiles.csv"
pancro_out = f"{os.environ['HOME']}/ekna_kiln_detect/inputs/{sys.argv[1]}/Tiled/pancro/"
RGB_out = f"{os.environ['HOME']}/ekna_kiln_detect/inputs/{sys.argv[1]}/Tiled/RGB/"
